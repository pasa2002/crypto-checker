...
export class ApiService {
  ...
  getTrendingCurency(currency:string){
  ...
  getConversionRate(coinId: string, targetCurrency: string){
    return this.http.get<any>(`https://api.coingecko.com/api/v3/simple/price?ids=${coinId}&vs_currencies=${targetCurrency}`)
  }

  getAllCryptocurrencies() {
    return this.http.get<any>('https://api.coingecko.com/api/v3/coins/list');
  }
